...
function Results() {
  ...
  const nextSteps = t(`guidance.${scenarioGuidanceKey}.next`)
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <section className="animate-fade-in-up animation-delay-500">
              <div className="card p-6">
                ...
                <PredictionList predictions={result.prediction.topPredictions} />
              </div>
            </section>
            ...
            <section className="animate-fade-in-up animation-delay-400">
              <div className="card p-6">
                ...
                <dl className="space-y-3 text-sm">
                  {[
                    [t('results.dateTime'), result.image.analyzedAt],
                    [t('results.age'), `${result.patient.age} ${t('results.years')}`],
                    [t('results.gender'), result.patient.gender],
                    [t('results.bodyRegion'), result.patient.region.charAt(0).toUpperCase() + result.patient.region.slice(1)],
                  ].map(([label, value]) => (
